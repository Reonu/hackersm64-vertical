...
DEFINE_LEVEL("HUB", LEVEL_HUB, COURSE_HUB, hub, generic, 20000, 0x00, 0x00, 0x00, _, sCamHub) 
DEFINE_LEVEL("TOWER_1", LEVEL_TOWER_1, COURSE_TOWER_1, tower_1, generic, 20000, 0x00, 0x00, 0x00, _, sCamTower1) 
